...
module.exports = function(grunt) {
  ...
  grunt.registerMultiTask('git_subtree_pull', 'A grunt task to work with pulling git subtrees', function() {
    var _defaults = {
      source: "",
      branch: "master",
      target: "",
    ...
    var _command = "git subtree pull --prefix=" + _options.target + " " + _options.source + " " + _options.branch;
